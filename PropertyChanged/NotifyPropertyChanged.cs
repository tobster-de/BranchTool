...
namespace PropertyChanged
{
    ...
    public abstract class NotifyPropertyChanged : INotifyPropertyChanged
    {
        ...
        public void OnPropertyChanged<T>(Expression<Func<T>> propertyExpression)
        {
            ...
            if (body == null) throw new ArgumentException("propertyExpression must return a property.");
        ...
        {
            if (EqualityComparer<T>.Default.Equals(refValue, newValue)) return;
        ...
        {
            if (property.Member.GetType().IsAssignableFrom(typeof(PropertyInfo))) Debug.Fail(string.Format(CultureInfo.CurrentCulture, "Invalid Property Expression {0}", propertyExpression));
        }
